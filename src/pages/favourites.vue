        ...
        <v-col cols="12" md="8">
            <div class="bg-white centered-div border">
                <v-container fluid class="rounded-xl">
                    ...
                    <v-row>
                        <v-col v-for="(item, index) in favourites" :key="index"
                            cols="12" sm="4" md="4">
                            <v-card class="text-center"
                                elevation="5" rounded="md">
                                ...
                                <v-card-actions>
                                    ...
                                    <v-btn class="absolute right-0" @click="addFavToCart(item)" color="primary">add to cart</v-btn>
                                </v-card-actions>
                            </v-card>
                        </v-col>
                    </v-row>
