<template>
    <v-container class="w-50">
        <v-data-table :hide-default-footer="true" :headers="headers" :items="cart_items">
            ...
            <template #item.action="{ item }">
                <v-btn color="error" icon @click="removeCartItem(item)">
        ...
        <v-btn :disabled="disableCheckout" @click="showPaymentPage" class="bg-secondary mx-10 px-10">
            Checkout
        </v-btn>
